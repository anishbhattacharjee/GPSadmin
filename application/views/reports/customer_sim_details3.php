									...
									<tbody id="reading_data">
										...
										while($res=mysqli_fetch_array($q)){
											...
											<tr class="parent" id="<?php echo $cid;?>">
												...
												<td>Active</td>
												<td  class="editable" data-type=$con,"select" data-source="{'Active': 'Active', 'Inactive': 'Inactive'}" id="reading_<?php echo $res['instatllation_id'];?>" data-id="<?php echo $res['instatllation_id']; ?>" data-dtype="sim_stat" data-value="<?php echo $sim_status;?>"><?php echo $sim_status;?></td>
											</tr>
											<?php	
										}
										...
										while($res=mysqli_fetch_array($q1)){
											...
											<tr class="parent" id="<?php echo $cid;?>">
												...
												<td><?php echo "CID".$cid." - ".$res['customer_first_name'];?></td>					
												<td>Expired</td>
												<td  class="editable" id="reading_<?php echo $res['r_id'];?>" data-id="<?php echo $res['r_id']; ?>"  data-type=$con,"select" data-source="{'Active': 'Active', 'Inactive': 'Inactive'}" data-dtype="r_sim_stat" data-value="<?php echo $sim_status;?>"><?php echo $sim_status;?></td>
											</tr>
											<?php	
											}
										}
