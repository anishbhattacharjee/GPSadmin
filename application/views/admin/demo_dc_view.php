...
$networks=array();
$neq=mysqli_query($con,"select sum(noofdevice) as ndev,start_date,end_date,network from customer_order_details where customer_id='$id' and order_id='$dcoid'  group by order_id");
								...
								$nq=mysqli_query($con,"select * from network where id='$networkk'");
