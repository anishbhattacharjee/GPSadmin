						...
						<?php	if(isset($msg2))
							...
							?>
								...
								<div class="infobox infobox-green  ">
										...
										<?php $cq= mysqli_query($con,"select sum(cashamount) as cnt from renew_cash");
...
<table cellpadding="0" cellspacing="3" border="0" class="table table-striped table-bordered" id="example">
									<thead>
										<tr>
											...
											<?php
											$slno=1;
											$q=mysqli_query($con,"select p.customer_id,p.order_id,p.cashamount,p.total_cashamount,p.time_stamp,c.customer_first_name,c.customer_uid FROM `renew_cash` p left join customers c on c.customer_id=p.customer_id");
