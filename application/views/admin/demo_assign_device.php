...
<div class="main-container container-fluid">
		...
		?>
				...
				$ss1=mysqli_query($con,"select * from customers where customer_id='$cid'");
							...
							$enq=mysqli_query($con,"select * from customer_orders where order_id='$order_id'");

							$renq=mysqli_fetch_array($enq);
...
<tbody><tr><th>&nbsp;&nbsp;Category</th><th style="margin-left: 50px;float: left;">Device Type</th><th style="margin-left: 50px;float: left;">Quantity</th><th style="margin-left: 81px;float: left;">Imei No</th><th style="margin-left: 150px;float: left;">Device Name</th><th style="margin-left: 150px;float: left;">SIM</th></tr>
							...
							$i=0;
								...
								$q=mysqli_query($con,"select * from customer_order_details o join gps_categories gc on gc.category_id=o.category_id where customer_id='$id' and order_id='$order_id' and assign='pending' and gc.type='main' ");
