						...
						<?php	if(isset($msg2))
							...
							?>
								...
								<div class="infobox infobox-green  ">
										...
										<?php $cq= mysqli_query($con,"select sum(amt) as cnt from renew_online");
...
<table cellpadding="0" cellspacing="3" border="0" class="table table-striped table-bordered" id="example">
									<thead>
										...
										<!--	<th>Cash Balance</th>-->
											...
											<?php
											$slno=1;
											$q=mysqli_query($con,"select * FROM  renew_online s left join customers cu on s.customer_id=cu.customer_id ");
