...
<table cellpadding="0" cellspacing="3" border="0" class="table table-striped table-bordered" id="example">
									...
									$slno=1;
									$iid=array();
									$q=mysqli_query($con,"select * from installation i join customers cs on cs.customer_id=i.customer_id join customer_orders co on co.order_id=i.order_id where co.type_order='live' and installation_status='pending' and assign_engineer='assigned'  order by i.order_id desc");
...
<table cellpadding="0" cellspacing="3" border="0" class="table table-striped table-bordered" id="example">
									...
									$slno=1;
									$iid=array();
									$q=mysqli_query($con,"select *  from installation i left join customer_orders c on c.order_id=i.order_id where  i.installation_status='pending' and c.created_by='$mid' and c.type_order='live'  and assign_engineer='assigned' order by i.order_id desc");
									while($res=mysqli_fetch_array($q))
									{
									$custid=$res['customer_id'];
									$engid=$res['engineer_id'];
...
<table cellpadding="0" cellspacing="3" border="0" class="table table-striped table-bordered" id="example">
									...
									$slno=1;
									$iid=array();
									$q=mysqli_query($con,"select *  from installation i left join customer_orders c on c.order_id=i.order_id where  i.installation_status='pending' and c.created_by='$mid'  and assign_engineer='assigned' order by i.order_id desc");
									while($res=mysqli_fetch_array($q))
									{
									$custid=$res['customer_id'];
									$engid=$res['engineer_id'];
