...
<div class="main-container container-fluid">
		...
		<?php include 'include/sidebar2.php';?>
			...
			$qcnt=mysqli_query($con,"select count(distinct(device_id)) as cnt from customer_order_details where customer_id='$id' and order_id='$order_id' and assign='pending' ");
			while($rq=mysqli_fetch_array($qcnt))
			{
				$cnt=$rq['cnt'];
			}
			?>
...
<?php
	$i=1;
			$q=mysqli_query($con,"select *,sum(noofdevice) as ndev from customer_order_details where customer_id='$id' and order_id='$order_id' and assign='pending' group by device_id");
...
<?php
$qqss=mysqli_query($con,"select * from gps_model_details where category_type='$catid' and device_id='$devid' ");
...
$qq=mysqli_query($con,"select * from company");
