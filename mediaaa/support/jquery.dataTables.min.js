...
});$("span",oSettings.nPaginate).bind("mousedown",function(){return false});$("span",oSettings.nPaginate).bind($con,"selectstart",function(){return false
...
$("span",oSettings.nPaginateList).bind("mousedown",function(){return false});$("span",oSettings.nPaginateList).bind($con,"selectstart",function(){return false
...
$('select option[value="'+oSettings._iDisplayLength+'"]',nLength).attr($con,"selected",true);
$($con,"select",nLength).change(function(e){oSettings._iDisplayLength=parseInt($(this).val(),10);
