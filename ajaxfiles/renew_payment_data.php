...
$total_cash=$cashamount+$totlcash;
	...
	$cshq=mysqli_query($con,"INSERT INTO renew_cash (customer_id, order_id,r_invid, cashtype, cashamount, cashpending, totlpayablecash, cashpaid,total_cashamount) VALUES ('$cid', '$oid','$r_invid', '$cashtype', '$cashamount', '$cashpending', '$totlpayablecash', '$cashpaid','$total_cash')");
...
$chonq=mysqli_query($con,"INSERT INTO renew_online (customer_id, order_id,r_invid, onlinetype, pending) VALUES ('$cid', '$oid','$r_invid', '$onlinetype', '$totalpending')");
...
if($amount==$paidamount)

	{
		...
		$uq=mysqli_query("update rpayment_list set status='done' where order_id='$oid' and r_invid='$r_invid'");

		$uq=mysqli_query("update renew_invoice set status='paid' where order_id='$oid' and id='$r_invid'");
...
";
	...
	$pyq=mysqli_query($con,"INSERT INTO rpayment_list (customer_id, order_id,r_invid, total_amount, paid_amount, pending_amount, status,cashamount,chequeamount,online_transfer_amount) VALUES ('$cid', '$oid','$r_invid', '$amount', '$paidamount', '$totalpending', '$status','$cashamount','$chequeamount','$onlinetransferamount')");
	...
	$raq=mysqli_query($con,"select * from renew_invoice where id='$r_invid'");

	$resaq=mysqli_fetch_array($raq);
	...
	//$raq=mysqli_query($con,"select * from installation where r_invoice='$r_invid'");
...
mail($to,$subject,$message,$headers);
		...
		$aqc=mysqli_query($con,"select * from admin_data where id='1'");
