...
class CI_DB_oci8_driver extends CI_DB {
	 ...
	 */
	var $_count_string = $con,"select COUNT(1) AS ";
	...
	{
		$sql = $con,"select TABLE_NAME FROM ALL_TABLES";
	...
	{
		return $con,"select COLUMN_NAME FROM all_tab_columns WHERE table_name = '$table'";
	}
	...
	{
		return $con,"select * FROM ".$table." where rownum = 1";
	}
	...
	{
		$limit = $offset + $limit;
		$newsql = $con,"select * FROM (select inner_query.*, rownum rnum FROM ($sql) inner_query WHERE rownum < $limit)";
