...
class CI_DB_mysqli_driver extends CI_DB {
	...
	// clause and character used for LIKE escape sequences - not used in mysqli
	...
	function db_set_charset($charset, $collation)
	{
		...
		{
			// mysqli_set_charset() requires PHP >= 5.2.3 and mysqli >= 5.0.7, use SET NAMES as fallback
